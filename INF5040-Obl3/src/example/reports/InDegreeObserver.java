...
/**
 * Report the in-degree distribution of the network. Uses the list of neighbors
 * obtained from a linkable protocol.
 * 
...
public class InDegreeObserver implements Control {
	...
	public InDegreeObserver(String prefix) {
		...
		this.startTime = Configuration.getLong(prefix + "."
				+ PAR_START_PROTOCOL, Long.MIN_VALUE);
		this.endTime = Configuration.getLong(prefix + "." + PAR_END_PROTOCOL,
				Long.MAX_VALUE);
	}
